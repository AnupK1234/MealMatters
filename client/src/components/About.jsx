        ...
        <div className="flex flex-col gap-6 mt-10">
          <div className="flex flex-col-reverse gap-4 md:flex-row">
            <div className="bg-[#f2f2f2a5] border-s-4 border-[#4cc6ec] shadow-lg rounded-md py-4 px-4 md:w-3/4">
              <h1 className="text-2xl font-bold mb-4 text-[#296b7f]">Our Mission</h1>
              <p className="text-lg">
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            ...
            <div className="bg-[#f2f2f2a5] border-e-4 border-[#4bc196] shadow-lg rounded-md py-4 px-4 md:w-3/4">
              <h2 className="text-2xl font-bold mb-4 text-[#358a6b]">How It Works</h2>
              <p className="text-lg">
          ...
          <div className="flex flex-col-reverse gap-4 md:flex-row">
            <div className="bg-[#f2f2f2a5] border-s-4 border-[#4cc6ec] shadow-lg rounded-md py-4 px-4 md:w-3/4">
              <h2 className="text-2xl font-bold mb-4 text-[#296b7f]">Join Us</h2>
              <p className="text-lg">
